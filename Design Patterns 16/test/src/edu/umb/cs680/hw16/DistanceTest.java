...
public class DistanceTest {
	...
	void test() {
		...
		double distMan = d.get(arrayToList(p1), arrayToList(p2), manhattan);
		
		assertEquals(6.23, distEuc);
		assertEquals(9.3, distMan);
		...
		double distMan_2 = d.get(arrayToList(p1_2), arrayToList(p2_2), manhattan);
		
		assertEquals(5.2, dist_2);
		assertEquals(9.0, distMan_2);
		...
		double distMan_3 = d.get(arrayToList(p1_3), arrayToList(p2_3), manhattan);
		
		assertEquals(7.65, dist_3);
		assertEquals(10.04, distMan_3);
		...
		double distMan_4 = d.get(arrayToList(p1_4), arrayToList(p2_4), manhattan);
		
		assertEquals(3.74, dist_4);
		assertEquals(6.0, distMan_4);
		...
		double distMan_5 = d.get(arrayToList(p1_5), arrayToList(p2_5), manhattan);

		assertEquals(1.73, dist_5);
		assertEquals(3.0, distMan_5);
