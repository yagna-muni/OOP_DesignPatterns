...
public class Distance {
	...
	public static void main(String args[]) {
		...
		System.out.println("Manhattan distance : " + new Distance().get(p1, p2, new Manhattan()));
		System.out.println("Manhattan distance matrix : " + new Distance().matrix(points, new Manhattan()));
	}
}
