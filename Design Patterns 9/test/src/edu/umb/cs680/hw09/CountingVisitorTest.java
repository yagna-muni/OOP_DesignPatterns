...
public class CountingVisitorTest {
	...
	@Test
	public void verifyCountingVisitorTest() {
		CountingVisitor visitor = new CountingVisitor("a");
		root.accept(visitor);

		assertEquals(7, visitor.getFileNum());

	}

	@Test
	public void verifyCountingVisitorTest1() {
		CountingVisitor visitor = new CountingVisitor("a");
		root.accept(visitor);
	...
	@Test
	public void verifyCountingVisitorTest2() {
		CountingVisitor visitor = new CountingVisitor("a");
		root.accept(visitor);
